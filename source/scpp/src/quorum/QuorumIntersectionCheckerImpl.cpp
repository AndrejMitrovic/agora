...
namespace stellar
{
void printMapSize (void* ptr)
{
    auto qmap = (QuorumTracker::QuorumMap*)ptr;
    printf("map size: %lu %lu\n", sizeof(QuorumTracker::QuorumMap), qmap->size());
}

std::shared_ptr<QuorumIntersectionChecker>
QuorumIntersectionChecker::create(const void* ptr)
{
    auto qmap = (QuorumTracker::QuorumMap*)ptr;
